...
const LeySegundaOportunidadPage = () => {
  return (
    <div>
      ...
      />
      <section className="mx-auto max-w-5xl px-4 2xl:px-0 py-16">
        <h2 className="text-2xl font-medium pb-6 text-gray-700">
        ...
        <p className=" text-gray-500">
          En 2023, más de{" "}
          <strong className="text-black">17.000 personas en España</strong> se
          acogieron con éxito a este proceso. Quieres ser el próximo ?
        </p>
      </section>
      <div className="bg-gray-50 py-16">
        <section className="mx-auto max-w-5xl px-4 2xl:px-0 ">
          ...
          <ul className="list-disc list-outside pl-4">
            <li className="text-gray-500 pb-4">
